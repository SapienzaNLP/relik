...
def create_windows(
    ...
    if output_file_path.exists():
        ...
        #     for line in f:
        #         latest_sample_written = json.loads(line)
        #         continue_from_id = latest_sample_written['doc_id']
        ...
        logger.info(f"Output file {output_file} already exists. Continuing from doc id {continue_from_id}")
    else:
...
def _process_batch(
    ...
    #         [document["text"] for document in data_dict.values()],
    #         window_size,
    #         window_stride,
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--write_batch_size", type=int, default=10_000)
